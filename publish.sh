...
# 动作：git init → commit → 创建 GitHub repo → push → 打 v2.0.2 tag
# ============================================================
set -e
...
TAG="v2.0.2"
TAG_MESSAGE="v2.0.2 推广运营增强版（含 MARKETING_VIDEO_SCRIPT.md + TRIGGERS.md）"
COMMIT_MESSAGE="feat: initial release v2.0.2"
...
echo "     $ gh release create $TAG --title 'v2.0.2 推广运营增强版' --notes-from-tag"
echo ""
echo "  3) 上传 v2.0.2 .zip 包附件："
echo "     $ gh release upload $TAG ../org-design-toolkit-v2.0.2-public.zip"
echo ""
